                    ...
                    <div className={styles.cardContent}>
                        ...
                        <div className={styles.cardBody}>
                            ...
                            <Row className={styles.rowStyle}>
                              <Col md={3} className={styles.rowStyleCol}>{doc.issuance_date}</Col>
                              <Col md={4} className={styles.rowStyleCol}>{doc.stakeholders}</Col>
                              <Col md={3} className={styles.rowStyleCol}>{doc.language}</Col>
                            </Row>
                            <Row>
                              <Col md={9}>
